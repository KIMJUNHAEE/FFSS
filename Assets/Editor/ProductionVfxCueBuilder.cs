...
namespace FFSS.Editor
{
    public static class ProductionVfxCueBuilder
    {
        ...
        private static readonly IReadOnlyList<VfxSeed> Seeds = new[]
        {
            ...
            new VfxSeed("vfx.card.shuffle", "vfx-card-shuffle.png", "Card_Shuffle",
                new Vector2(310f, 310f), 0.54f, new Vector2(0.56f, 0.56f), new Vector2(1.02f, 1.02f),
                new Vector2(0.86f, 0.86f), new Vector2(-8f, 6f), -5f, Color.white),
